...
module.exports.SUMDETAIL =  async (req,res)=>{
  ...
  //var q2 = "SELECT SUM(Amount) AS 'RealFood' FROM " +ulke + " WHERE Estimated = 'NO' AND Category = 'Food'";
    var q1 = "SELECT SUM(Amount) AS 'Food' FROM " + ulke + " WHERE Estimated = '" + hangi + "' AND Category = 'Food'";
    var q2 = "SELECT SUM(Amount) AS 'Lodging' FROM " + ulke + " WHERE Estimated = '" + hangi + "' AND Category = 'Lodging'";
    var q3 = "SELECT SUM(Amount) AS 'Trans' FROM " + ulke + " WHERE Estimated = '" + hangi + "' AND Category = 'Transportation'";
    var q4 = "SELECT SUM(Amount) AS 'Other' FROM " + ulke + " WHERE Estimated = '" +hangi + "' AND Category = 'Other'";
